                    ...
                    <div class="box box-primary">
                            ...
                            <div class="box-tools">
                                <div class="input-group">
                                    <input type="text" name="search" class="form-control input-sm pull-right"
                                           style="width: 150px;" placeholder="商品代码/名字"
                            ...
                            <table id="productTable" class="table table-hover table-bordered table-striped">
                                ...
                                <g:each in="${products}">
                                    <tr id="tr_${it.id}">
                                        ...
                                        <td></td>
                                        <td></td>
                                        <td id="td_dateCreated_${it.id}"><g:formatDate format="yyyy-MM-dd hh:mm:ss"
                                                                                       date="${it.dateCreated}"/></td>
                                        <td>
                        ...
                        <div class="box-footer">
                            <div class="pagination pull-right">
                                <g:paginate controller="product" action="index" total="${total}"
                                            params='[order: "desc", sort: "productName"]'/>
                            </div>
                        </div>
                    </div><!-- /.box -->
                </form>
